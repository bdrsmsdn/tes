...
public class Gallery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerViewAdapterGallery = new com.programmer.uts10119212.AdapterRecyclerViewGallery(subjectsGallery, subjectImageGallery,contextGallery );
    ...
    public void ClickProfile(View view){
        //redirect to profile
        com.programmer.uts10119212.HomeActivity.redirectActivity(this,Profile.class);
    }
