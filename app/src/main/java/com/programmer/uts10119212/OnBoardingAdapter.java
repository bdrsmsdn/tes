...
public class OnBoardingAdapter extends  RecyclerView.Adapter<OnBoardingAdapter.OnBoardingViewHolder> {
    ...
    private List<com.programmer.uts10119212.OnBoardingItem> onBoardingItemList;

    public OnBoardingAdapter(List<com.programmer.uts10119212.OnBoardingItem> onBoardingItemList) {
    ...
    class OnBoardingViewHolder extends RecyclerView.ViewHolder{
        ...
        void setOnBoardingData(com.programmer.uts10119212.OnBoardingItem onBoardingItem){
