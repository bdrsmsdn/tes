...
public class Daily extends AppCompatActivity {
    ...
    String[] subjects = {
            "Wake Up", "Take a Bath", "Have a Breakfast", "Studying", "Work as Barista", "Hangout","Sleep"
    };
    int[] subjectImage ={
            R.drawable.ic_bangun,R.drawable.ic_mandi,
            R.drawable.ic_food,R.drawable.ic_kuliah,
            R.drawable.ic_kuliah,R.drawable.ic_film,
            R.drawable.ic_tidur
    };
    String[] subjectsName = {
            "Temen", "Temen", "Temen"
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerViewAdapterFriend = new com.programmer.uts10119212.AdapterRecyclerViewFriend(subjectsName, subjectImageFriend,contextFriend );
    ...
    public void ClickGallery(View view){
        //redirect to gallery
        HomeActivity.redirectActivity(this, com.programmer.uts10119212.Gallery.class);
    }
