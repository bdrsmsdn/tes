...
public class Profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        instagram.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                gotoUrl("https://www.instagram.com/mirsyadibrahim/");
            }
        });
        ...
        location.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                gotoUrl("https://maps.app.goo.gl/n2cpn4DUwdz8C2KX9");
            }
        });
        //ass
    ...
    public void ClickMusic(View view) {
        //redirect to music
        com.programmer.uts10119212.HomeActivity.redirectActivity(this, com.programmer.uts10119212.Music.class);
    ...
    public static void About(final Activity activity) {
        ...
        //set message
        builder.setMessage("ICAD APPS v1.0 Aplikasi ini memuat data pribadi M. Irsyad Ibrahim");
    ...
    public void onButtonTap(View v) {
        ...
        intent.putExtra(Intent.EXTRA_EMAIL, new String[]{"muhammadirsyadibrahim21@gmail.com"});
    ...
    public void callClick(View view) {
        ...
        intentCall.setData(Uri.parse("tel:082127616536"));
